...
Route::middleware('auth')->group(function () {
    ...
    Route::get('products/{product}/download-qr', [ProductController::class, 'downloadQr'])->name('products.download-qr');
    Route::get('products/{product}/download-qr-png', [ProductController::class, 'downloadQrPng'])->name('products.download-qr-png');
