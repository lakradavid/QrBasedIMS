...
<div class="py-4 max-w-lg">
    <form method="POST" action="{{ route('locations.store') }}" class="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
        @csrf
        <div class="grid sm:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="code" value="{{ old('code') }}" required placeholder="e.g. WH-A1"
            ...
            <div>
                ...
                <input type="text" name="aisle" value="{{ old('aisle') }}"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
            </div>
            <div class="sm:col-span-2">
