...
<div class="flex h-full">
    ...
    <aside class="hidden lg:flex lg:flex-col lg:w-64 bg-indigo-700 text-indigo-100 flex-shrink-0">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <div class="pt-2 mt-2 border-t border-indigo-600/50">
                <p class="px-4 pb-1 text-indigo-400 text-xs font-semibold uppercase tracking-wider">Superadmin</p>
                <a href="{{ route('admin.index') }}"
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition-colors hover:bg-white/10 {{ request()->routeIs('admin.*') ? 'bg-white/20 text-white' : '' }}">
        ...
        <div class="px-4 py-4 border-t border-indigo-600">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-indigo-300 text-xs truncate">{{ ucfirst(auth()->user()->role) }}</p>
                </div>
